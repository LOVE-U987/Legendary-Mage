...
public class ActiveAndPassiveAbilityMagicSwordItem extends MagicSwordItem {
    public ActiveAndPassiveAbilityMagicSwordItem(Tier pTier, Properties pProperties, SpellDataRegistryHolder[] spellDataRegistryHolders) {
