...
public class PaleFlameRenderer extends EntityRenderer<PaleFlame> {
    private static final ResourceLocation[] TEXTURES = {
            ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID, "textures/entity/pale_flame/pale_flame_1.png"),
            ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID,"textures/entity/pale_flame/pale_flame_2.png"),
            ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID,"textures/entity/pale_flame/pale_flame_3.png"),
            ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID, "textures/entity/pale_flame/pale_flame_4.png")
    };
