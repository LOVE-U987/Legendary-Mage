...
public class BlackFlameLarge  extends BlackFlameNormal {
    private static final EntityDataAccessor<Boolean> DATA_MIRRORED = SynchedEntityData.defineId(BlackFlameLarge.class, EntityDataSerializers.BOOLEAN);
    public BlackFlameLarge(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    public BlackFlameLarge(Level level, boolean mirrored) {
        this(GGEntityRegistry.BLACK_FLAME_LARGE.get(), level);
        if (mirrored) {
